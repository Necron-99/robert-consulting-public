...
class BlogManager {
  ...
  loadPosts() {
    ...
    this.posts = [
      ...
      },
      {
        ...
        title: 'AIOps',
        excerpt: 'Artificial Intelligence for IT Operations, predictive analytics, automation',
        content: 'blog-posts/tuesday-2025-11-04.html',
      ...
      },
      {
        ...
        category: 'cicd',
        tags: ['CI/CD', 'Pipeline Optimization', 'DevOps Automation', 'Build Performance', 'Deployment Speed'],
        icon: '⚙️',
        readTime: '10 min read'
      }
    ];
  ...
  groupPostsByWeek() {
    ...
    // Debug: Log week information (commented out for production)
